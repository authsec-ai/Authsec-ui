pipeline {
    ...
    environment {
        ...
        TAG = 'stage'
        // Defined AFTER TAG on purpose — referencing ${TAG} before it exists
        // in the same block evaluates to an empty string.
        DOCKER_IMAGE = "docker-repo-public.authnull.com/authsec-ui:${TAG}"
    }
