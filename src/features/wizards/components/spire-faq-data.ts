...
data:
  config.yaml: |
    ...
    icp_service:
      address: "https://<your-api-host>/spiresvc"
...
services:
  ...
  icp-agent:
    ...
    environment:
      ...
      - ICP_AGENT_ICP_SERVICE__ADDRESS=https://<your-api-host>/spiresvc
...
curl http://localhost:8080/healthz`,
            ...
            },
            {
              ...
              code: `# Set variables
export ICP_SERVER_URL="https://<your-api-host>/spiresvc"
...
curl -fsSL https://install.authsec.ai/icp-agent.sh | sudo bash -s -- \\
  ...
  --icp-server "https://<your-api-host>/spiresvc" \\
